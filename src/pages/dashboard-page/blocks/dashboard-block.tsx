        ...
        <TabsContent value="crops" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-1">
            <Card className="w-full flex items-center ">
              <CardHeader>
                <CardTitle>Объем-цена по культурам</CardTitle>
                <CardDescription>
                  Корреляция между объемом и ценой по культурам
                </CardDescription>
              </CardHeader>
              <CardContent className="h-96">
                {isLoading ? (
                ...
                ) : volumePriceCorrelation.length > 0 ? (
                  <ResponsiveContainer width="100%" height="100%">
                    <ScatterChart
                      margin={{
                        top: 20,
                    ...
                    >
                      ...
                      <YAxis
                        ...
                        tickFormatter={(value) => value.toLocaleString()}
                      />
                      <ZAxis type="category" dataKey="currency" name="Валюта" />
                      <Tooltip
                      ...
                      <Scatter
                        name="USD"
                        data={volumePriceCorrelation.filter(
